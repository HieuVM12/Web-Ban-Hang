                    ...
                    <form role="form" method="post" action="{{ route('admin.brand.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input value="{{ old('name')}}" name="name" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập Tên Thương hiệu">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="website" type="text" class="form-control" id="exampleInputEmail1" placeholder="Nhập tên website" value="{{old('website')}}">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Vị trí</label>
                                <input name="position" type="number" class="form-control" id="exampleInputEmail1" min="0" value="{{old('position')}}">
                            </div>
