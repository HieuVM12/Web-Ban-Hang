                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputFile">Số lượng (<span style="color: red">*</span>)</label>
                                        <input value="{{old('stock')}}" style="width: 100px" type="number" class="form-control" id="stock" name="stock" min="0">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('price')}}" type="number" class="form-control" id="price" name="price"  min="0">
                                    </div>
                                </div>
                                <!-- /.col-lg-6 -->
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{old('sale')}}" type="number" class="form-control" id="sale" name="sale"  min="0">
                                    </div>
                                </div>
                                <!-- /.col-lg-6 -->
                            </div>
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="1" name="is_active" {{old('is_active')?'checked':''}}> <b>Hiển Thị</b>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" value="1" name="is_hot" {{old('is_hot')?'checked':''}}> <b>Sản phẩm Hot</b>
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
