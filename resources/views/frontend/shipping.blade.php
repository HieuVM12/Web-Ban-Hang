        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="product-delivery-option">
                                ...
                                <table class="table table-bordered delivery-table">
                                    <tr>
                                        ...
                                        <td class="delivery-method-icon">
                                            <img src="/frontend/img/bank.png" alt="" />
                                        </td>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered delivery-table">
                                    <tr>
                                        ...
                                        <td class="delivery-method-icon">
                                            <img src="/frontend/img/delivery-method.jpg" alt="" />
                                        </td>
                                        <td class="carrey-info">
                                            <strong>BootExperts</strong><br>
                    ...
                    <div class="terms-of-service">
                        ...
                        <div class="form-group new-ac-form-group p-info-group ">
                            ...
                            <span class="agree">I agree to the terms of service and will adhere to them unconditionally.<a href="/frontend/#">(Read the Terms of Service)</a></span>
                        </div>
                    </div>
                ...
                <div class="returne-continue-shop">
                    ...
                    <a href="/frontend/checkout.html" class="procedtocheckout">Proceed to checkout<i class="fa fa-chevron-right"></i></a>
                </div>
