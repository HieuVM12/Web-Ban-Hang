                ...
                <div class="shoping-cart-menu">
                    <ul class="step">
                        ...
                        <li class="step-todo second step-done">
                            <span><a href="/frontend/checkout-signin.html">02. Sign in</a></span>
                        </li>
                        <li class="step-todo third step-done">
                            <span><a href="/frontend/checkout-address.html">03. Address</a></span>
                        </li>
                        <li class="step-todo four step-done">
                            <span><a href="/frontend/checkout-shipping.html">04. Shipping</a></span>
                        </li>
                    ...
                    <table class="table table-bordered" id="cart-summary">
                        ...
                        <tr>
                            <td class="cart-product">
                                <a href="/frontend/#">
                                    <img alt="Faded" src="/frontend/img/product/cart-image3.jpg">
                                </a>
                            </td>
                        ...
                        <tr>
                            <td class="cart-product">
                                <a href="/frontend/#">
                                    <img alt="Blouse" src="/frontend/img/product/cart-image2.jpg">
                                </a>
                            </td>
                            <td class="cart-description">
                                <p class="product-name"><a href="/frontend/#">Summer Clothing Sleeves T-shirt</a></p>
                                <small>SKU : demo_2</small>
                                <small><a href="/frontend/#">Size : S, Color : Blac</a></small>
                            </td>
                            <td class="cart-avail">
                                <span class="label label-success">In stock</span>
                            </td>
                        ...
                        <tr>
                            <td class="cart-product">
                                <a href="/frontend/#">
                                    <img alt="Faded" src="/frontend/img/product/cart-image1.jpg">
                                </a>
                            </td>
                            <td class="cart-description">
                                <p class="product-name"><a href="/frontend/#">Casual Printed Dress</a></p>
                                <small>SKU : demo_3</small>
                                <small><a href="/frontend/#">Size : L, Color : Green</a></small>
                            </td>
                            <td class="cart-avail">
                                <span class="label label-success">In stock</span>
                            </td>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="four-payment-method">
                    ...
                    <div class="single-payment-method payment-method-one">
                        <a href="/frontend/#">Pay by bank wire<span> (order processing will be longer)</span><i class="fa fa-chevron-right"></i></a>
                    </div>
                    <!-- SINGLE-PAYMENT-METHOD END -->
                    <!-- SINGLE-PAYMENT-METHOD START -->
                    <div class="single-payment-method payment-method-two">
                        <a href="/frontend/#">Pay by check<span> (order processing will be longer)</span><i class="fa fa-chevron-right"></i></a>
                    </div>
                    <!-- SINGLE-PAYMENT-METHOD END -->
                    <!-- SINGLE-PAYMENT-METHOD START -->
                    <div class="single-payment-method payment-method-three">
                        <a href="/frontend/#">Pay by paypal<span> (order processing will be longer)</span><i class="fa fa-chevron-right"></i></a>
                    </div>
                    <!-- SINGLE-PAYMENT-METHOD END -->
                    <!-- SINGLE-PAYMENT-METHOD START -->
                    <div class="single-payment-method payment-method-four">
                        <a href="/frontend/#">Pay by master card<span> (order processing will be longer)</span><i class="fa fa-chevron-right"></i></a>
                    </div>
                    <!-- SINGLE-PAYMENT-METHOD END -->
                </div>
