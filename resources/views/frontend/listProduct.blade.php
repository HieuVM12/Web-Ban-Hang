                    ...
                    <div class="product-shooting-area">
                        <div class="product-shooting-bar">
                            ...
                            <div class="view-systeam">
                                ...
                                <ul>
                                    <li><a href="/frontend/shop-gird.html"><i class="fa fa-th-large"></i></a><br />Grid</li>
                                    <li class="active"><a href="/frontend/shop-list.html"><i class="fa fa-th-list"></i></a><br />List</li>
                                </ul>
                            </div>
                            <!-- VIEW-SYSTEAM END -->
                        </div>
                                    ...
                                    <div class="list-view-content">
                                        <div class="single-product-item">
                                            ...
                                            <div class="overlay-content-list">
                                                <ul>
                                                    <li><a href="/frontend/#" title="Add to cart" class="add-cart-text">Add to cart</a></li>
                                                    <li><a href="/frontend/#" title="Quick view"><i class="fa fa-search"></i></a></li>
                                                    <li><a href="/frontend/#" title="Add to compare"><i class="fa fa-retweet"></i></a></li>
                                                    <li><a href="/frontend/#" title="Add to wishlist"><i class="fa fa-heart-o"></i></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
