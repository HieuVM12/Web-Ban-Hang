        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                ...
                <div class="form-group primary-form-group p-info-group chose-address">
                    ...
                    <a href="/frontend/#">Use the delivery address as the billing address.</a>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="first_item primari-box">
                    ...
                    <ul class="address">
                        ...
                        <li class="update-button">
                            <a href="/frontend/my-cart-step-2-info.html">Update<i class="fa fa-chevron-right"></i></a>
                        </li>
                    </ul>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="add-new-address">
                    <a href="/frontend/my-cart-step-2-info.html" class="new-address-link">Add a new address<i class="fa fa-chevron-right"></i></a>
                ...
                <div class="returne-continue-shop ship-address">
                    ...
                    <a href="/frontend/checkout-shipping.html" class="procedtocheckout">Proceed to checkout<i class="fa fa-chevron-right"></i></a>
                </div>
