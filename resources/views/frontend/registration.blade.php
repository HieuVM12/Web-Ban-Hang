                    ...
                    <form class="primari-box personal-info-box" id="personalinfo" method="post" action="#">
                        ...
                        <div class="personal-info-content">
                            ...
                            <div class="form-group primary-form-group p-info-group">
                                ...
                                <a href="/frontend/#">Sign up for our newsletter!</a>
                            </div>
                            <div class="form-group primary-form-group p-info-group">
                                <label class="cheker">
                                    <input type="checkbox" name="checkbox">
                                ...
                                <a href="/frontend/#">Receive special offers from our partners!</a>
                            </div>
                            <div class="submit-button p-info-submit-button">
                                <a href="/frontend/checkout-address.html" id="SubmitCreate" class="btn main-btn">
											<span>
												Register
